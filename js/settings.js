...
export const SETTINGS = {
  "Pulse React":        { group: "Pulse",     value: 0.47, min: 0,    max: 100.0,    step: 0.001, dec: 2 },
  "Pulse Freq":         { group: "Pulse",     value: 1090, min: 50,   max: 16000,  step: 5,     dec: 0 },
  "Pulse Width":        { group: "Pulse",     value: 0.47, min: 0.25, max: 4,      step: 0.01,  dec: 2 },
  "Brightness React":   { group: "Pulse",     value: 1.90, min: 0,    max: 20.0,    step: 0.001, dec: 2 },
  "Brightness Freq":    { group: "Pulse",     value: 6268, min: 50,   max: 16000,  step: 5,     dec: 0 },
  "Brightness Width":   { group: "Pulse",     value: 0.65, min: 0.25, max: 4,      step: 0.01,  dec: 2 },
  "Brightness Smooth":  { group: "Pulse",     value: 0.86, min: 0,    max: 1,      step: 0.01,  dec: 2 },
  "Motion React":       { group: "Motion",    value: 0.57, min: 0,    max: 1.0,    step: 0.001, dec: 2 },
  "Motion Freq":        { group: "Motion",    value: 135,  min: 50,   max: 16000,  step: 5,     dec: 0 },
  "Motion Width":       { group: "Motion",    value: 1.30, min: 0.25, max: 4,      step: 0.01,  dec: 2 },
  "Pulse Smooth":       { group: "Pulse",     value: 0.86,  min: 0,    max: 1,    step: 0.01, dec: 2},
  ...
  "Smoothing Factor":   { group: "Timing",    value: 1.0,  min: 0,    max: 1,    step: 0.01, dec: 2},
  ...
  "Preamp Gain":        { group: "Audio",     value: -12.0,  min: -60,  max: 60,   step: 0.5,  dec: 1 },
  ...
  "Motion Smooth":      { group: "Motion",    value: 0.74, min: 0,    max: 1,    step: 0.01, dec: 2},
